...
- 这是微信 AI 小程序里的 `craft-beer-guide` Skill，用于精酿啤酒、BJCP 官方标准风格、BA/WBC/GABF 市场扩展风格、口味推荐、收藏和学院文章场景。
- 当用户说“想喝点清爽不苦的”“配烧烤喝什么”“找西海岸 IPA”“21A 是什么”“看看我的收藏”“推荐入门文章”等，优先按下方意图分流调用 API。
